...
namespace SDL
{
	...
	// Uso tipico:
	// openAudio( 22050, MIX_DEFAULT_FORMAT, 2, 4096)
	// openAudio( 44100, MIX_DEFAULT_FORMAT, 2, 4096)
	bool openAudio(int freq, Uint16 format, int channels, int chunksize);
	...
	// Combinacion de stopAllSound y haltMusic
	// Para la reproduccion en todos los canales (incluyendo la musica).
